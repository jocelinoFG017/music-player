...
- `[R]`: ativar ou desativar o replay da música atual
...
uma música diferente da atual. Com o replay ligado, a música atual recomeça
automaticamente ao terminar. Ao sair, o comando é encerrado.
